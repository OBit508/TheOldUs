...
namespace TheOldUs.Roles.Impostors
{
    ...
    {
        [TranslationHelper("acidMaster_tsunamiSpeed")]
        [ModdedNumberOption(null, 1, 15, 0.5f, null, true, NumberSuffixes.Multiplier)]
        public static float TsunamiSpeed => 5;
        [TranslationHelper("acidMaster_acidCooldown")]
        [ModdedNumberOption(null, 5, 60)]
        public static float AcidCooldown => 15;
        [TranslationHelper("acidMaster_acidUses")]
        [ModdedNumberOption(null, 0, 10, 1, null, true, NumberSuffixes.None)]
        public static int AcidUses => 3;
        [TranslationHelper("acidMaster_extraCooldown")]
        [ModdedNumberOption(null, 0, 60)]
        public static float ExtraKillCooldown => 15;
        [TranslationHelper("acidMaster_dissolveDelay")]
        [ModdedNumberOption(null, 5, 30)]
